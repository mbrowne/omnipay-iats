...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\iATS\Message\CreditCardRequest', $request);
    ...
    public function testCompleteAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\iATS\Message\TransactionReferenceRequest', $request);
    ...
    public function testUpdateCard()
    {
        ...
        $this->assertInstanceOf('\Omnipay\iATS\Message\CardReferenceRequest', $request);
